...
Use those two information to determine the price and room type for the hotel based on the below data:
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" please insert how many days you planning to stay at the hotel?");
        int days= input.nextInt();
        System.out.println(" please introduce the party size" );
        ...
        switch (size){
            ...
            case 7:
                ...
                break;
            default:
                System.out.println("Sorry we dont have any available rooms for that size party");
                statement=false;
        }if(statement)
            System.out.println( "For the party of "+size+" persons we offer "+roomType+" for "+days+ " days will cost $"+price);
